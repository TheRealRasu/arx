...
public class Test extends Example{
	...
	public static void main (String[] args){
        ...
        data.getDefinition().setDataType("OrderedString", DataType.ORDERED_STRING);
        ...
        StatisticsSummary statSum=dataH.getStatistics().getSummaryStatistics(true).get("String");
        
        
        
        statSum=dataH.getStatistics().getSummaryStatistics(true).get("String");
        barSeries.displayData(statSum, "String", dataH);
        
        statSum=dataH.getStatistics().getSummaryStatistics(true).get("OrderedString");
        ...
        statSum=dataH.getStatistics().getSummaryStatistics(true).get("integer");
        barSeries.displayData(statSum, "integer", dataH);
        
        statSum=dataH.getStatistics().getSummaryStatistics(true).get("decimal");
